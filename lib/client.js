	...
	factory: (require) => {
		...
		*/
		...
		function turnOf(event) {
			...
			if (event.type === "user/message" && event.data?.source?.kind === "plugin") return openNativeTurn;
		}
...
[data-native-subagent-panel][data-state="running"] [data-disclosure-row]::after {
  ...
  pointer-events: none;
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_49d5cb5441f586af10c9b0d862c69a25/node_modules/dsh-llm-providers-ui/lib/model-catalog.js
		const inputStyle = {
			boxSizing: "border-box",
			width: "100%",
			minHeight: 36,
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_49d5cb5441f586af10c9b0d862c69a25/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_49d5cb5441f586af10c9b0d862c69a25/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		function ExternalAgentsSection({ t, load, save, run, quota: readQuota, ...slot }) {
			...
			const fetchQuota = async () => {
				...
				try {
					...
					if (next.status === "ready") {
						...
						if (hit?.bucket.remainingFraction !== void 0) rememberHeadlineQuota("cursor-agent", "Cursor", {
			...
			const headerQuota = snapshot !== void 0 && !snapshot.rows[0]?.authenticated ? void 0 : liveQuota ?? headerQuotaFromCache(peekCachedUsage("cursor-agent"));
