	...
	factory: (require) => {
		...
		*/
		...
		function CursorAgentReadonlyCard({ callId, toolName, nativeName, summary, block, t, conversationT }) {
			...
			const rawTodos = toolName === "todo_write" ? record(parse(args)).todos : void 0;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolBody, {
								toolName,
								args,
								result,
								state: rowState,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: conversationT("row.inspect")
							}),
		...
		function ToolBody({ toolName, args, result, state, t }) {
			...
			const text = typeof output === "string" && output === result && /^[\s]*[\[{]/u.test(output) ? void 0 : outputText(output);
			if (toolName === "read" && state !== "error" && result === "") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			if (state !== "error") {
				...
				if (toolName === "edit" || toolName === "write") {
					...
					if (diffs.length > 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DiffBlock, {
						diffs,
						maxLines: 9,
						labels: {
							...labels("diff"),
				...
				if (toolName === "bash" && typeof command === "string" && (result === void 0 || terminalOutput !== void 0)) {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.TerminalBlock, {
						command,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IOCard, {
				args,
				result: result === void 0 ? void 0 : text ?? result,
				state,
				t
			});
		}
		function IOCard({ args, result, state, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [args === "" ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: ioSection,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						style: ioText,
						children: pretty(args)
					})]
				}), result === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-card-result": state,
					style: {
						...ioSection,
						borderTop: args === "" ? void 0 : "1px solid var(--dsw-alias-border-l2)"
					},
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							color: "var(--dsw-alias-label-caption)",
						...
						style: {
							...ioText,
							color: state === "error" ? "var(--dsw-alias-state-error-primary)" : void 0
						},
						children: pretty(result)
					})]
				})]
			});
		}
