window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		async function loadActivityRecords(rpc, sessionId, signal) {
		...
		*/
		async function bootstrapNativeHistory(sessionId, entry, rpc, controller) {
		...
		*/
		...
		async function pollNativeHistory(sessionId, entry, rpc) {
			...
			try {
				try {
					if (!entry.bootstrapped) changed = await bootstrapNativeHistory(sessionId, entry, rpc, controller);
					else changed = await followNativeHistory(sessionId, entry, rpc, controller);
				} catch (caught) {
...
[data-native-subagent-panel][data-state="running"] [data-disclosure-row]::after {
  ...
  pointer-events: none;
		...
		*/
		...
		//#endregion
		//#region ../dsh-acp-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/model-catalog.js
		const inputStyle = {
			boxSizing: "border-box",
			width: "100%",
			minHeight: 36,
		...
		*/
		...
		//#endregion
		//#region ../dsh-acp-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		...
		*/
		...
		//#endregion
		//#region ../dsh-acp-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
