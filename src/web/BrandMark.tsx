...
export function BrandMark(): ReactNode {
  return (
    <svg width={SIZE} height={SIZE} viewBox="0 0 24 24" aria-hidden="true" style={{ flex: 'none' }}>
      <path fill="currentColor" d={CURSOR_BRAND_PATH} />
    </svg>
  )
}
